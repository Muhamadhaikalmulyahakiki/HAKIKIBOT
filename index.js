...
/////////////////
const BotName = 'Rawr BOT☄'; 
const instagram = 'https://instagram.com/muhamadhaikalmulyahakiki'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'KETIKA HAIKAL MENGAKTIFKAN BOTNYA'; 
const youtube = 'https://youtube.com/channel/UC3Os6LPNvccqOGTDnBim8dg';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@muhamadhaikalmulyahakiki')
